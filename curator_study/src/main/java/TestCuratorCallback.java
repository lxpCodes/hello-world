...
/**
 * @ClassName TestCuratorCallback
 * @Description  BackgroundCallback 接口以及 CuratorListener 监听器的基本使用
 * @Author liangxp
 * @Date 2020/8/20 20:06
 **/
public class TestCuratorCallback {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 注意:下方所有操作都添加了inBackground()方法，转为后台操作
        ...
        client.getChildren().inBackground(
                new BackgroundCallback() {
                    public void processResult(CuratorFramework curatorFramework, CuratorEvent curatorEvent) throws Exception {
                        System.out.println("in background: eventType=" + curatorEvent.getType() + ", eventPath=" + curatorEvent.getPath());
                    }
                }
        ).forPath("/user");
